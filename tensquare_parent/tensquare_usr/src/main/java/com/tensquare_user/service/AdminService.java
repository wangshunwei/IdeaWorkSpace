package com.tensquare_user.service;

import com.tensquare_user.dao.AdminDao;
import com.tensquare_user.pojo.Admin;
...
public class AdminService {
	...
	public Admin login(Admin admin) {
		...
		// 查询数据库
		Admin a = adminDao.findByLoginname(loginname);
		// 判断
		if(a == null){
			return null;
		}
		...
		// 判断密码是否匹配
		boolean matches = bcryptPasswordEncoder.matches(admin.getPassword(), a.getPassword());
		if(matches){
			// 说明，匹配成功
			return a;
		}else{
